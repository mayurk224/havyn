  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md transition-all duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {user ? (
                <DropdownMenu rotate={true}>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="relative h-9 w-9 rounded-full ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
                    >
                ...
                <Link to="/login">
                  <Button
                    variant="default"
                    size="sm"
                    className="rounded-full px-5 h-9 font-medium shadow-sm hover:shadow-md transition-all"
                  >
                    Login
                  </Button>
                </Link>
        ...
        {/* Sub Navbar */}
        <div
          className={`flex-col md:flex-row items-center justify-between gap-2 py-3 border-t md:h-14 ${isSearchOpen ? "flex" : "hidden md:flex"}`}
        >
